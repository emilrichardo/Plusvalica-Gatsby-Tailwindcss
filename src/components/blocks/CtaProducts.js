...
const CtaProducts = () => {
    ...
    <div className="container mx-auto px-5 md:px-16 py-10 md:py-44 relative md:flex items-center">
        <img className="  md:w-1/2 left-0 top-0 object-cover object-center md:h-100  transition-all " src={team} />
        <div className="caption md:w-3/5 md:relative md-right-0 md-left-auto  md:pl-24">
            ...
            <Button variant="primary text-center" className="mt-5 w-full md:w-auto">Ver propiedades</Button>
        </div>
